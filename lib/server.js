...
var require_sync_engine = __commonJS({
  "src/mission-control/linear/sync-engine.js"(exports2, module2) {
    ...
    function createLinearSyncEngine2({
      config,
      dataDir,
      client,
      now = Date.now,
    ...
    module2.exports = {
      createLinearSyncEngine: createLinearSyncEngine2,
      verifySignature,
      isFreshTimestamp,
...
var require_linear = __commonJS({
  "src/mission-control/linear/index.js"(exports2, module2) {
    ...
    var { createLinearSyncEngine: createLinearSyncEngine2, verifySignature } = require_sync_engine();
    module2.exports = {
      createLinearClient,
...
var LINEAR_SYNC = createLinearSyncEngine({
...
function handleMissionControlApi(req, res, pathname) {
  ...
  if (pathname === "/api/mission-control/admin/reconcile") {
    ...
    LINEAR_SYNC.reconcile({ reason: "manual-admin" }).then((nextState) => {
      if (typeof state.invalidateStateCache === "function") {
        state.invalidateStateCache();
      }
      writeJson(res, 200, {
